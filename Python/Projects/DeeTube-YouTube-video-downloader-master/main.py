...
def d_thread():
    ...
    while True:
        if dwnlded:            
            ...
            if r == 'yes':
                os.startfile(r'C:\Users\andro\Videos\Downloads')
            dlod.destroy()
            break
        else:
            continue
...
logo = PhotoImage(file=r'C:\Users\andro\OneDrive\Desktop\Projects\DeeTube-YouTube-video-downloader-master\resources\logo.png')
...
download_img = PhotoImage(file=r'C:\Users\andro\OneDrive\Desktop\Projects\DeeTube-YouTube-video-downloader-master\resources\download.png')
