...
var_input = open(r"C:\Users\andro\OneDrive\Desktop\Projects\Mood-Analysis-master\read.txt").read()
...
for i in range(0,len(filtered_words)):
    with open(r'C:\Users\andro\OneDrive\Desktop\Projects\Mood-Analysis-master\em.txt') as f:
        for line in f:
            finaline = line.strip()
